...
class EditService extends StatelessWidget {
  ...
  bool isFormValid(ServicesController controller) {
    ...
    print("sprice: ${controller.spriceController.text}");
    print("Category: ${controller.categoryvalue.value}");
    print("Subcategory: ${controller.subcategoryvalue.value}");
    print("Images: ${controller.sImagesList}");
...
// Filter and cast the list to List<String> to get a list of image URLs
    ...
    // List<String> sImagesLinks   []; // Initialize an empty list or assign it the appropriate value
