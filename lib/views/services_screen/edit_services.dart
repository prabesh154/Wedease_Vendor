...
//     return controller.snameController.text &&
...
//                         label: 'Service Name',
//                          controller: controller.snameController?? "${data['s_name']}"
                        
//                       ),

//                       10.heightBox,
//                       customTextField(
//                                                  controller: controller.slocationController?? "${data['s_name']}",
...
//                         label: 'Features',
//                         isDesc: true,
//                                                  controller: controller.sfeaturesController?? "${data['s_name']}"
...
//                         hint: 'e.g. Rs. 1000',
//                         label: 'Rate/Price',
//                                                  controller: controller.spriceController?? "${data['s_name']}"
...
//                         label: 'Description',
//                                                  controller: controller.sdescriptionController?? "${data['s_name']}"
